...
import { getEntryBySlug, getFirstEntry, CONTENT_TYPES, getAssetUrl, getGalleryUrls } from '@/lib/contentful';
...
export default async function PortfolioDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const client = (fields.client as string) || '';
      ...
      <main className="flex-1">
        ...
        <section className="py-10 sm:py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {description && (
              <div className="prose prose-slate max-w-none mb-8 sm:mb-10 text-sm sm:text-base leading-relaxed text-slate-600 whitespace-pre-line">
                {description}
              </div>
            )}
            ...
            {galleryUrls.length > 0 && (
              <div>
                <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-4 sm:mb-6">Galeri</h2>
